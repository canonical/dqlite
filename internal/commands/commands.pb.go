...
// source: internal/commands/commands.proto
// DO NOT EDIT!
...
/*
	...
	It is generated from these files:
		internal/commands/commands.proto
...
func (*Command_Open) isCommand_Params()       {}
func (*Command_Begin) isCommand_Params()      {}
func (*Command_WalFrames) isCommand_Params()  {}
func (*Command_Undo) isCommand_Params()       {}
func (*Command_End) isCommand_Params()        {}
func (*Command_Checkpoint) isCommand_Params() {}
...
func (m *Command) GetOpen() *Open {
	if x, ok := m.GetParams().(*Command_Open); ok {
		return x.Open
	}
	return nil
}
...
func (m *Command) GetBegin() *Begin {
	if x, ok := m.GetParams().(*Command_Begin); ok {
		return x.Begin
	}
	return nil
}
...
func (m *Command) GetWalFrames() *WalFrames {
	if x, ok := m.GetParams().(*Command_WalFrames); ok {
		return x.WalFrames
	}
	return nil
}
...
func (m *Command) GetUndo() *Undo {
	if x, ok := m.GetParams().(*Command_Undo); ok {
		return x.Undo
	}
	return nil
}
...
func (m *Command) GetEnd() *End {
	if x, ok := m.GetParams().(*Command_End); ok {
		return x.End
	}
	return nil
}
...
func (m *Command) GetCheckpoint() *Checkpoint {
	if x, ok := m.GetParams().(*Command_Checkpoint); ok {
		return x.Checkpoint
	}
	return nil
}
...
func _Command_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 2: // Params.begin
		...
		msg := new(Begin)
		err := b.DecodeMessage(msg)
		m.Params = &Command_Begin{msg}
		return true, err
	case 3: // Params.wal_frames
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(WalFrames)
		err := b.DecodeMessage(msg)
		m.Params = &Command_WalFrames{msg}
		return true, err
	case 4: // Params.undo
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
	...
	case 5: // Params.end
		...
		msg := new(End)
		err := b.DecodeMessage(msg)
		m.Params = &Command_End{msg}
		return true, err
	case 6: // Params.checkpoint
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Checkpoint)
		err := b.DecodeMessage(msg)
		m.Params = &Command_Checkpoint{msg}
		return true, err
	default:
		return false, nil
	}
...
func init() {
	...
	proto.RegisterType((*Open)(nil), "commands.Open")
	proto.RegisterType((*Begin)(nil), "commands.Begin")
	proto.RegisterType((*WalFrames)(nil), "commands.WalFrames")
	proto.RegisterType((*WalFramesPage)(nil), "commands.WalFramesPage")
	proto.RegisterType((*Undo)(nil), "commands.Undo")
	proto.RegisterType((*End)(nil), "commands.End")
	proto.RegisterType((*Checkpoint)(nil), "commands.Checkpoint")
}
...
func init() { proto.RegisterFile("internal/commands/commands.proto", fileDescriptorCommands) }

var fileDescriptorCommands = []byte{
	// 443 bytes of a gzipped FileDescriptorProto
	,
}
