...
static void *setup(const MunitParameter params[], void *user_data)
{
	...
	if (rc != 0) {
		munit_errorf("failed to register vfs: %s - %d", sqlite3_errstr(rc), rc);
	}
 ...
 * error.. */
static MunitResult test_open_wal_before_db(const MunitParameter params[], void *data)
{
	sqlite3_vfs * vfs  = data;
	sqlite3_file *file = munit_malloc(vfs->szOsFile);
...
static MunitResult test_close_then_delete(const MunitParameter params[], void *data)
{
	sqlite3_vfs * vfs  = data;
	sqlite3_file *file = munit_malloc(vfs->szOsFile);
...
static MunitResult test_read_never_written(const MunitParameter params[], void *data)
{
	sqlite3_vfs * vfs  = data;
...
static MunitResult test_write_database_header(const MunitParameter params[], void *data)
{
	sqlite3_vfs * vfs  = data;
	sqlite3_file *file = __file_create_main_db(vfs);
 ...
 * page. */
static MunitResult test_write_and_read_database_pages(const MunitParameter params[], void *data)
{
	sqlite3_vfs * vfs  = data;
	sqlite3_file *file = __file_create_main_db(vfs);
...
static MunitResult test_write_and_read_wal_frames(const MunitParameter params[], void *data)
{
	sqlite3_vfs * vfs   = data;
	...
	rc = file2->pMethods->xWrite(file2, __buf_header_wal_frame(), 24, 32 + 24 + 512);
	munit_assert_int(rc, ==, 0);
...
static MunitResult test_truncate_database(const MunitParameter params[], void *data)
{
	sqlite3_vfs * vfs  = data;
	sqlite3_file *file = __file_create_main_db(vfs);
...
static MunitTest dqlite__vfs_tests[] = {
	{ "_open/exclusive", test_open_exclusive, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_open/again", test_open_again, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_open/noent", test_open_noent, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_open/enfile", test_open_enfile, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_open/wal-before-db", test_open_wal_before_db, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_delete", test_delete, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_delete/busy", test_delete_busy, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_delete/enoent", test_delete_enoent, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_access", test_access, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_access/noent", test_access_noent, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_full_pathname", test_full_pathname, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_close/then-delete", test_close_then_delete, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_read/never-written", test_read_never_written, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_write/database-header", test_write_database_header, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_write/database-pages",
	  test_write_and_read_database_pages,
	  setup,
	  tear_down,
	  MUNIT_TEST_OPTION_NONE,
	  NULL },
	{ "_write/wal-frames", test_write_and_read_wal_frames, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_truncate/database", test_truncate_database, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_truncate/wal", test_truncate_wal, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_register", test_register, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_register/twice", test_register_twice, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
	{ "_snapshot", test_snapshot, setup, tear_down, MUNIT_TEST_OPTION_NONE, NULL },
