...
CU_TestInfo dqlite__schema_handler_encode_suite[] = {
	{"two uint64 fields",      test_dqlite__schema_handler_encode_two_uint64},
	{"uint64 and text fields", test_dqlite__schema_handler_encode_uint64_and_text},
	{"unknown type",           test_dqlite__schema_handler_encode_unknown_type},
	CU_TEST_INFO_NULL,
};
...
CU_TestInfo dqlite__schema_handler_decode_suite[] = {
	{"invalid text",      test_dqlite__schema_handler_decode_invalid_text},
	{"unknown type",      test_dqlite__schema_handler_decode_unknown_type},
	{"two uint64 fields", test_dqlite__schema_handler_decode_two_uint64},
	CU_TEST_INFO_NULL,
};

CU_SuiteInfo dqlite__schema_suites[] = {
	{
		"dqlite__schema_handler_encode",
		NULL, NULL,
		test_dqlite__schema_setup, test_dqlite__schema_teardown,
		dqlite__schema_handler_encode_suite
	},
	{
		"dqlite__schema_handler_decode",
		NULL, NULL,
		test_dqlite__schema_setup, test_dqlite__schema_teardown,
