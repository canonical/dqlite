...
TEST_MESSAGE_SEND_IMPLEMENT(leader, DQLITE_REQUEST_LEADER, dqlite__request, DQLITE__REQUEST_SCHEMA_LEADER);
TEST_MESSAGE_SEND_IMPLEMENT(client, DQLITE_REQUEST_CLIENT, dqlite__request, DQLITE__REQUEST_SCHEMA_CLIENT);
...
TEST_MESSAGE_SEND_IMPLEMENT(server, DQLITE_RESPONSE_SERVER, dqlite__response, DQLITE__RESPONSE_SCHEMA_SERVER);
