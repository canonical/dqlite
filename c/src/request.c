...
DQLITE__SCHEMA_IMPLEMENT(dqlite__request_prepare, DQLITE__REQUEST_SCHEMA_PREPARE);
...
DQLITE__SCHEMA_IMPLEMENT(dqlite__request_finalize, DQLITE__REQUEST_SCHEMA_FINALIZE);
DQLITE__SCHEMA_IMPLEMENT(dqlite__request_exec_sql, DQLITE__REQUEST_SCHEMA_EXEC_SQL);
DQLITE__SCHEMA_IMPLEMENT(dqlite__request_query_sql,
                         DQLITE__REQUEST_SCHEMA_QUERY_SQL);
DQLITE__SCHEMA_IMPLEMENT(dqlite__request_begin, DQLITE__REQUEST_SCHEMA_BEGIN);
DQLITE__SCHEMA_IMPLEMENT(dqlite__request_commit, DQLITE__REQUEST_SCHEMA_COMMIT);
DQLITE__SCHEMA_IMPLEMENT(dqlite__request_rollback, DQLITE__REQUEST_SCHEMA_ROLLBACK);
