...
DQLITE__SCHEMA_IMPLEMENT(dqlite__request_heartbeat, DQLITE__REQUEST_SCHEMA_HEARTBEAT);
...
DQLITE__SCHEMA_IMPLEMENT(dqlite__request_query_sql, DQLITE__REQUEST_SCHEMA_QUERY_SQL);
