...
DQLITE__SCHEMA_IMPLEMENT(dqlite__request_helo,      DQLITE__REQUEST_SCHEMA_HELO);
...
DQLITE__SCHEMA_DECODER_IMPLEMENT(dqlite__request, DQLITE__REQUEST_SCHEMA_TYPES);
