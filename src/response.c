...
SCHEMA__IMPLEMENT(response_result_, RESPONSE__SCHEMA_RESULT);
SCHEMA__IMPLEMENT(response_rows_, RESPONSE__SCHEMA_ROWS);
SCHEMA__IMPLEMENT(response_empty_, RESPONSE__SCHEMA_EMPTY);
